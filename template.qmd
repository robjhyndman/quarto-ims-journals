...
This template helps you to create a properly formatted manuscript for IMS journals. Set the `ims-journal` field in the YAML header to the appropriate journal code (e.g., `sts` for *Statistical Science*, `aos` for *Annals of Statistics*).

## Citation

For numbered citation journals, always use square brackets. For example, [@r1] or for multiple bibliography items [@r1; @r2; @r3; @r4]. For name-year citation journals, you can drop the square brackets for in-text citations. Citation style is determined automatically from the `ims-journal` field in the YAML header.
